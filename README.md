...
[![version](https://img.shields.io/badge/version-3.3.0-4a90d9)](CHANGELOG.md)
...
npm run package     # dist/glp-ultra-v3.3.0.zip
```

### Firefox

```bash
npm run package:firefox   # dist/extension-firefox/ + dist/glp-ultra-firefox-v3.3.0.zip
```
