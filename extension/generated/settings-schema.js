...
window.GLP_SCHEMA = {
  ...
  "sections": [
    {
      ...
      "items": [
        ...
        {
          "key": "safeMode",
          "label": "Safe Mode (ignore custom CSS)"
        },
        {
          "key": "overrideDarkReader",
          "label": "Take Precedence Over Dark Reader"
        }
      ],
      "specialId": null
    },
  ...
  "palettes": {
    "midnight": {
      ...
      "link": "#78b7ff",
      "linkHover": "#a4ceff",
      "hover": "rgba(79,156,249,0.10)",
      "headerBg": "rgba(15,24,42,0.94)",
      "titleBg": "rgba(11,19,34,0.88)",
      "border": "#243248"
    },
    "catppuccin": {
      "bg": "#1e1e2e",
